...
#La cartella di input verrà cercata nella stessa cartella dalla quale viene eseguito questo script. 
INPUT_DIR   = "misure_stabilita_grezze"            # cartella con i file .dat cumulativi
OUTPUT_DIR  = "dati_stabilità"  # cartella di destinazione dei differenziali
...
def sort_files(file_list, method):
...
def compute_differentials(cumulative_spectra,
                           clip_negative: False
                           ):
    """
...
def print_statistics(differentials,
                     filenames):
...
def save_differentials(differentials,
                       output_dir,
                       filenames):
...
def plot_summary(cumulative_spectra,
                 differentials) -> None:
...
def plot_preview(differentials,
                 filenames,
                 n):
